...
h3. Define a node and get a node client bean

In your spring context file, just define a node like this:

bc. <elasticsearch:node id="esNode" />
