 ...
 */
class XMLParserUtil {
    static boolean getElementBooleanValue(Element element, String attribute) {
        return getElementBooleanValue(element, attribute, false);
    }

    static boolean getElementBooleanValue(Element element, String attribute, boolean defaultValue) {
        if (!element.hasAttribute(attribute)) return defaultValue;
        return Boolean.valueOf(getElementStringValue(element, attribute));
    }

    static String getElementStringValue(Element element, String attribute) {
