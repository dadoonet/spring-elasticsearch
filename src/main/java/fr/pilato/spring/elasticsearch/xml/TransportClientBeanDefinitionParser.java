...
class TransportClientBeanDefinitionParser extends ClientBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        client = buildTransportClientDef(clientBuilder, esNodes, plugins);
