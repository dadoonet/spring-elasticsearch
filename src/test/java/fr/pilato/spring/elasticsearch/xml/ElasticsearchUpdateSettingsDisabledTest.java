...
public class ElasticsearchUpdateSettingsDisabledTest {
	static protected ConfigurableApplicationContext ctx;
	
	@BeforeClass
	static public void setup() {
		ctx = new ClassPathXmlApplicationContext("fr/pilato/spring/elasticsearch/xml/es-update-settings-disabled-test-context.xml");
	}
